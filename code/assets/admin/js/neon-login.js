...
//                            http://sunstargym.com/ibrand/login
                                ...
                                setTimeout(function()
                                {
                                    ...
                                    {  
                                        neonLogin.setPercentage(100, function()
                                        {
                                            ...
                                            setTimeout(function()
                                            {	
//                                                http://sunstargym.com/ibrand/dashboard
					...
					*/
                        ...
                        setTimeout(function()
                        {
                            ...
                            $.ajax({ 
                                ...
                                url: 'http://web.socialinfotech.com/hypertech/admin/lockscreen/login',
                                method: 'POST',
                                dataType: 'json',
                                data: {
                                ...
                                success: function(response)
                                {
                                    ...
                                    setTimeout(function()
                                    {
                                        ...
                                        if(login_status == 'invalid')
                                        {                                               
                                             window.location.href = 'http://localhost/ecommerce/lockscreen';                                                                  
                                        }								
                                        if(login_status == 'success')
                                        {                                                                     
