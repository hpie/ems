...
class Blog extends MY_Controller {
	...
	public function __construct()
	{
		...
		$this->push_breadcrumb('Blog');
	}

	public function index()
	{
		redirect('blog/item/1');
	}

	public function item($blog_id)
	{
		$this->mViewData['blog_id'] = $demo_id;
		$this->render('blog/item');
	}
	...
	public function blog_post($post_id)
	{
		...
		$this->push_breadcrumb('Blog Posts', 'blog/blog_posts');
	...
	// See views/blog/form_basic.php for sample code
