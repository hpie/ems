...
$facultyQualification = array(
    "Graduation  GRAD"=>"Graduation  GRAD",
    "PG Diploma  PGDIP"=>"PG Diploma  PGDIP",
    "Post Graduation  POSTGRAD"=>"Post Graduation  POSTGRAD",
    );

define("facultyQualification",json_encode($facultyQualification));
