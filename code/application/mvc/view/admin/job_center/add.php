    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-body">						
                <form role="form" class="form-horizontal" method="post" action="<?php echo BASE_URL; ?>job_center/insert" enctype="multipart/form-data">			
                   
                   <div class="form-group">
                        <label class="col-sm-3 control-label">Center  Code</label>                              
                          <div class="col-sm-5">
                            <input type="text" name="center_code" reuired class="form-control"  placeholder="Center Code" id="center_code">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Center  title</label>                              
                          <div class="col-sm-5">
                            <input type="text" name="center_title" reuired class="form-control"  placeholder="Center Title" id="center_title">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <textarea name="center_description" class="form-control" placeholder="Center Description" ></textarea>    
                            </div>
                    </div> 
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Center  Address1</label>                              
                          <div class="col-sm-5">
                            <input type="text" name="center_address1" class="form-control"  placeholder="Center Address1" id="center_address1">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Center  Address2</label>                              
                          <div class="col-sm-5">
                            <input type="text" name="center_address2" class="form-control"  placeholder="Center Address1" id="center_address2">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Center Zip</label>                              
                          <div class="col-sm-5">
                            <input type="text" name="center_zip" class="form-control"  placeholder="Center Zip" id="center_zip">
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Center Email</label>                              
                          <div class="col-sm-5">
                            <input type="text" name="center_email" class="form-control"  placeholder="Center Email" id="center_email">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Center Phone</label>                              
                          <div class="col-sm-5">
                            <input type="text" name="center_phone" class="form-control"  placeholder="Center Phone" id="center_phone">
                     ...
                     <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="center_contact_name" class="form-control"  placeholder="Center Contact Name" id="center_contact_name">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="center_contact_designation" class="form-control" placeholder="Center Contact Designation" id="center_contact_designation">
