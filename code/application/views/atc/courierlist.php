...
jQuery("#listtable").jqGrid({
  url:'<?php echo $base_url.'index.php/atc/courierData'?>',
  mtype : "post", 
  datatype: "json",
  height: 'auto',
  rowNum: 9,
  rowList: [3,6,9],
    ...
    colModel:[
      ...
      {name:'courier_status',index:'courier_status', width:70, sorttype:"text", editable:true, edittype:"checkbox",editoptions: {value:"Recieved:Pending"}},
    ...
    editurl: "<?php echo $base_url.'index.php/atc/editCourier'?>",
    postData:{q:1},
    pager: "#plisttable",
    viewrecords: true,
    sortname: 'row_id',
