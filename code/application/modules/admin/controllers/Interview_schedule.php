...
class Interview_schedule  extends Admin_Controller {
	...
	public function index()
	{
		...
		$crud->set_relation('job_code','job_postings','{job_code}',array('1' => '1'), ' job_code ASC');
		$crud->set_relation('center_code','job_interview_centers','{center_title}',array('1' => '1'), ' center_code,center_title ASC');
		...
		$crud->edit_fields('job_code','department_code','center_code','interview_dt', 'interview_start_time', 'interview_end_time', 'interview_report_time', 
		              'interview_close_time','interview_schedule_status','interview_schedule_comments', 'status','modified_by');
		...
		$this->mPageTitle = 'Job Interview Schedule';
		$this->render_crud();
	}
